...
class SearchForm extends CFormModel {
    ...
    public function rules() {
        return array(
            // Simple form
            array('age, popular, status', 'safe', 'on' => 'simple'),
            array('words', 'length', 'min' => 2, 'max' => 255, 'on' => 'simple'),
            array('words', 'sphinxSyntaxValidator', 'on' => 'simple'),
        );
    }

    public function attributeLabels() {
        return array('words' => Yii::t('site_texts', 'Keywords'));
    }
